...
class Graph():
    ...
    def get_adjacency_matrix(self, labeling_mode=None):
        ...
        elif labeling_mode == 'spatialrelationpair':
            A = tools.get_spatial_relation_pair_graph(num_node, self_link, inward, outward, neighbor)
        elif labeling_mode == 'completerelationpair':
            A = tools.get_complete_relation_pair_graph(num_node, self_link, inward, outward, neighbor)
